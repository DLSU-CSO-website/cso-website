...
const ViewAnnouncement = () => {
  ...
  const deleteNotifIdRef = useRef<string>("");
  ...
  useEffect(() => {
    if (editLoading) {
      notifIdRef.current = notifications.show({
        ...
        message:
          "Just sit down and chill we're doing cool things in the background!",
        autoClose: false,
    ...
    if (deleteLoading) {
      deleteNotifIdRef.current = notifications.show({
        loading: true,
    ...
    <>
      ...
      >
        <div className="flex flex-col gap-5 text-center">
          <Input.Wrapper
            label="Are you sure about this? This is irreversible"
            description="To delete please type DELETE"
            className="w-full"
          >
            <Input
              value={deleteString}
          ...
          <Button color="red" onClick={deleteAnnouncement}>
            DELETE
          </Button>
        </div>
      </Modal>
      <div className="w-full min-h-screen flex justify-center items-center py-10">
        <div className="w-1/2 h-full flex flex-col gap-5 justify-center items-center">
          <Input.Wrapper
            label="Title"
            description="Please write the title of the announcement here!"
            className="w-full"
          >
            <Input
              value={title}
          ...
          <Input.Wrapper
            ...
            label="Body"
            description="Please write the announcement body here."
          >
            <RichTextEditor
              editor={editor}
